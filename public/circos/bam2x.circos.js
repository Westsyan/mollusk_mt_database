     ...
     */
     ...
     C.LinkView.prototype={
         render: function(coordinates){
                ...
                g.append("a").attr("xlink:href", "/RiceRC/SV/blocksBefore?id=" + self.model.id).attr("target","_blank")
				.append("path")
                .attr("d",
                        d3.svg.chord()
                    ...
                    .on("mouseover", function() {
                          d3.select(this).style('fill','lightblue').style("opacity",1.0);
                    ...
                    .append("title").text("Block ID:"+ self.model.bid +"\n"+self.model.source.name+":"+Math.floor(self.model.source.start)+"-"+(Math.floor(self.model.source.end) + Math.floor(self.model.source.start)*99)/100+"\nto\n"+self.model.target.name+":"+Math.floor(self.model.target.start)+"-"+(Math.floor(self.model.target.end) + Math.floor(self.model.target.start)*99)/100+"\n"
                    )
            }
     };
